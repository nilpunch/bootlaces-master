...
public class ObjectDragger : MonoBehaviour 
{
	...
	void OnMouseDown()
	{
		...
		offset = gameObject.transform.position - Camera.main.ScreenToWorldPoint(new Vector3(UnityEngine.Input.mousePosition.x, UnityEngine.Input.mousePosition.y, screenPoint.z));
	}
